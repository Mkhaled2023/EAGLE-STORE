                            ...
                            <form action="" wire:submit.prevent="addProduct">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        placeholder="Enter Product Name" wire:model="name" wire:keyup="generateSlug">
                                    @error('name')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="sku" class="form-control"
                                        placeholder="Enter Regular Price" wire:model="sku">
                                    @error('sku')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-3 mt-3">
                                    <label for="regular_price" class="form-label" wire:model="stock_status">Stock
                                        Status</label>
