...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/logo/eagle_logo.jpg') }}">
                ...
                <div class="container">
                    <div class="header-wrap">
                        <div class="logo logo-width-1">
                            <a href="/"><img src="{{ asset('assets/imgs/logo/eagle_logo.jpg') }}"
                                    alt="logo"></a>
                        </div>
                ...
                <div class="container">
                    <div class="header-wrap header-space-between position-relative">
                        <div class="logo logo-width-1 d-block d-lg-none">
                            <a href="index.html"><img src="{{ asset('assets/imgs/logo/eagle_logo.jpg') }}"
                                    alt="logo"></a>
                        </div>
                        <div class="header-nav d-none d-lg-flex">
                            ...
                            <div class="hotline d-none d-lg-block">
                                <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+20) 100-707-2332 </p>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="widget-about font-md mb-md-5 mb-lg-0">
                                    ...
                                    <p class="wow fadeIn animated">
                                        <strong>Address: </strong>6 October 8th Distract
                                    </p>
                                    <p class="wow fadeIn animated">
                                        <strong>Phone: </strong>+201007072332
                                    </p>
                                    <p class="wow fadeIn animated">
                                        <strong>Email: </strong>muhammadkhaled99999@gmail.com
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <p class="text-lg-end text-start font-sm text-muted mb-0">
                                &copy; <strong class="text-brand">Muhammadkhaled</strong> All rights reserved
                            </p>
                        </div>
                    </div>
                </div>
